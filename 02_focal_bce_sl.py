...
CFG = dict(
    ...
    seed = 42,
    data_dir = "./data",
    output_dir = "./output_02_softlabel_focal_bce",
    device = "cuda",
)
...
def soft_focal_bce_loss(scores, labels_soft, class_weights, gamma=2.0):
...
for epoch in range(CFG["num_epochs"]):
    ...
    for batch in train_loader:
        ...
        l_main = soft_focal_bce_loss(scores, lbls, class_weights_tensor, CFG["focal_gamma"])
