...
CFG = dict(
    ...
    seed = 42,
    data_dir = "./data",
    output_dir = "./output_02_onehot_focal_bce",
    device = "cuda",
)
...
train_dataset = GoEmotionsDataset(train_df, tokenizer, CFG["max_length"])
...
def focal_bce_loss(scores, labels, class_weights, gamma=2.0):
...
for epoch in range(CFG["num_epochs"]):
    ...
    for batch in train_loader:
        ...
        l_bce = focal_bce_loss(scores, lbls, class_weights_tensor, CFG["focal_gamma"])
